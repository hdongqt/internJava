...
const categoryAPI = {
    ...
    createCategory(category){
        return axios.post(CATEGORY_BASE_REST_API_URL, category,{headers : authHeader()})
    },

    getCategoryById(categoryId){
        return axios.get(CATEGORY_BASE_REST_API_URL + '/' + categoryId,{headers : authHeader()})
    },

    updateCategory(category){
        return axios.put(CATEGORY_BASE_REST_API_URL + '/' + category.id,category,{headers : authHeader()})
    },
