...
const Librarian  = {
    ...
    getListBorrow(filters){
        ...
        return axios.get(READER_BASE_REST_API_URL+`/borrow?${paramString}`,{headers : authHeader()})
    },
    getInfo(){
    ...
    deleteHistory(id){
        return axios.delete(READER_BASE_REST_API_URL, {
            headers:authHeader(),
            data: [id]
          });
    },
    changePassword(info){
        return axios.put(READER_BASE_REST_API_URL+'/password',info,{headers : authHeader()});
    }
}
export {Librarian};
