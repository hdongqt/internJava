...
import {required,vusername,validEmail,vpassword,validCustom} from 'utils/handelValidate';
             ...
             <div className="form-group">
              ...
              <div className="form-group">
                ...
                <Input
                  ...
                  validations={[required, validCustom(3,8)]}
                />
              </div>
              ...
              <div className="form-group">
                <label htmlFor="categoryCode">Hình ảnh(*)</label>
                <Input
                  type="file"
                  className="form-control"
                  name="total"
