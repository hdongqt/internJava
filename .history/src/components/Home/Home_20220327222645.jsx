...
const defaultBaner = [
  {
    ...
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCJRCaMhVfUS22snPUE0Q3Jw17NonpGzWB6Q&usqp=CAU"
  },
  {
    ...
    img: "https://st.quantrimang.com/photos/image/2019/06/03/hinh-nen-sach-3.jpg"
  },
  {
    author: "Voltaire",
    ...
    img: "https://i.pinimg.com/550x/49/c0/9d/49c09d570d21f2636401c50f8be25100.jpg"
  },
  {
    author: "Henry David Thoreau",
    content: "Sách là nguồn của cải quý báu của thế giới và là di sản xứng đáng của các thế hệ và các quốc gia.",
    img: "https://s.meta.com.vn/img/thumb.ashx/Data/image/2021/03/16/cau-noi-hay-ve-sach-1.jpg"
  }
]


export default function Home() {
  const [banner, setBanner] = useState(defaultBaner[Math.floor(Math.random() * defaultBaner.length)] )
     ...
     <div className="jumbotron p-3 p-md-5 text-white rounded bg-dark mt-5">
       <div className="row">
        <div className="col-md-8 px-0">
          <h4 className="display-4 font-italic">{banner.author}</h4>
          <p className="lead my-3">{banner.content}</p>
        </div>
        <div className="col-md-4">
       <div className="d-flex justify-content-end">
       <img src={banner.img} alt="anh"
      ...
      <div className="row">
       ...
       {
         books.map(book=>{
           return  <div key={book.id} className="col-md-6">
