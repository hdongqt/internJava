  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        {!context.user && 
          <a href="/login" className="btn btn-outline-primary" type="submit" style={{marginRight: "5px"}}>Login</a>
          <a href="/register" className="btn btn-outline-primary" type="submit" style={{marginRight: "5px"}}>Login</a>
        }
         {
           context.user &&
           <>
