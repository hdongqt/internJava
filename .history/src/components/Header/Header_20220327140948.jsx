  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        {!context.user && 
          <Link to="/login" className="btn btn-outline-primary" style={{marginRight: "5px"}}>Login</Link>
          <Link to="/register" className="btn btn-outline-primary" style={{marginRight: "5px"}}>Login</Link>
        }
         {
           context.user &&
           <>
