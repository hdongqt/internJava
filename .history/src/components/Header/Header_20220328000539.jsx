  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        {!context.user &&
        <>
          <Link to="/login" className="btn btn-outline-primary me-3 btn-border-white">Đăng nhập</Link>
          <Link to="/register" className="btn btn-outline-success btn-border-white" >Đăng ký</Link>
          </>
        }
         {
           context.user &&
